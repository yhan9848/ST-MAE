...
The following figure shows the main flow of our action recognition.
<div align=center><img width="50%" src="fig/1.png"/></div>


## About worker actions (WA) datasets
We select eight typical worker actions that are common in intelligent assembly tasks: wearing a hat (WH), opening a box to get a tool (OB), hammering a nail (HN), using tape (UT), using a wrench (UW), closing a box (CB), picking up and dropping a workpiece (PDW), and moving a box (MB). The following figure shows an example of some of the actions in our dataset.
